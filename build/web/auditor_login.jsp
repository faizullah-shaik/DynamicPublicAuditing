		...
		<div class="container">
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="active"><a href="auditor_login.jsp">AUDITOR</a></li>
...
<div class="container">
		...
		<ol class="breadcrumb">
			<li><a href="index.html">Home</a></li>
			<li class="active">TPAU access</li>
		</ol>
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title" style="color:whitesmoke">Auditor Sign in</h1>
				</header>
					...
					<div class="panel panel-default" style="background-color:#07c49c">
						<div class="panel-body">
							<h3 class="thin text-center" style="color:whitesmoke">Sign in to your account</h3>
							<hr>
							
							<form action="auditor_login" method="get">
								<div class="top-margin">
                                                                    <label style="color:black">Auditor ID <span class="text-danger">*</span></label>
								...
								<div class="row">
									<div class="col-lg-4 text-right">
                                       ...
                                       <div style="height: 340px; width: 640px;margin-left: 550px; background-image: url('assets/images/audi.jpg')">
                                       </div>
                                 </div>
