...
<div class="container">
		...
		<ol class="breadcrumb">
			<li><a href="index.html">Home</a></li>
			<li class="active">Cloud access</li>
		</ol>
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title" style="color:whitesmoke">Cloud Sign in</h1>
				</header>
                         ...
                         <div style="width:500px;height: 300px;border-top-left-radius: 19px;border-bottom-left-radius: 19px;float: left;">
                             ...
                             <div class="panel panel-default" style="background-color:#063f5c">
						<div class="panel-body">
							<h3 class="thin text-center" style="color:whitesmoke">Sign in to your account</h3>
							<hr>
							
							<form action="cloud_login" method="get">
								<div class="top-margin">
                                                                    <label style="color:black">Cloud ID <span class="text-danger">*</span></label>
								...
								<div class="row">
									<div class="col-lg-4 text-right">
                                       ...
                                       <div style="height: 340px; width: 580px;margin-left: 550px; background-image: url('assets/images/cldd.jpg')">
                                       </div>
                                 </div>
