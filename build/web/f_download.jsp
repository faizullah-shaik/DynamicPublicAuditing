		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title" style="color:whitesmoke">File Download</h1>
				</header>
            ...
            %>
                                ...
                                <td><a href="download?<%=rs.getString("file_name")%>,<%=rs.getString("file_owner")%>" ><button class="button">Download</button></a> </td>
