		...
		<ol class="breadcrumb">
			...
			<li><a href="f_upload.jsp">File Upload</a></li>
                        <li><a href="f_details.jsp">File View</a></li>
                         ...
                         <li class="active">ARBITRATOR'S MESSAGE</li>
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title" style="color:whitesmoke">ARBITRATOR'S Message</h1>
				</header>
				<div class="jumbotron top-space">
                                    <table border="1" width="700px" hieght="1200px" style="text-align: center;background-color:coral">
            ...
            System.out.println("mail: " + mail);
                                    ...
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from arbitrator where file_owner='"+mail+"'");
                                        while (rs.next()) {
