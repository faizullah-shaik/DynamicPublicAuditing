...
<div class="container">
		...
		<ol class="breadcrumb">
			<li><a href="index.html">Home</a></li>
			<li class="active">TPAR access</li>
		</ol>
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title" style="color:whitesmoke">Arbitrator Sign in</h1>
				</header>
					...
					<div class="panel panel-default" style="background-color:#6ccff6">
						<div class="panel-body">
							<h3 class="thin text-center" style="color:black">Sign in to your account</h3>
							<hr>
							
							<form action="arbitrator_login" method="get">
								<div class="top-margin">
                                                                    <label style="color:black">Arbitrator ID <span class="text-danger">*</span></label>
								...
								<div class="row">
									<div class="col-lg-4 text-right">
                                       ...
                                       <div style="height: 250px; width: 500px;margin-left: 550px; background-image: url('assets/images/cld.jpg')">
                                       </div>
                                 </div>
