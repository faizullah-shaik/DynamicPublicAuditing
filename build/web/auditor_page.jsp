...
<div class="container">
		...
		<ol class="breadcrumb">
			<li class="active">Auditor Home</li>
                        <li><a href="pkey_page.jsp">User Public Key</a></li>
			<li><a href="f_audit.jsp">File Audit</a></li>
		...
		<br>		<!-- /Article -->
 <center><h1 class="page-title" style="color:brown">AUDITOR HOME</h1></center>
                                ...
                                <br>
                               <center>
                            <h1 style="color:whitesmoke"> Welcome, Auditor!</h1>
