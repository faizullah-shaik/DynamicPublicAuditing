		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title" style="color:whitesmoke">Public Key</h1>
				</header>
						...
						<div class="panel-body">
							<h3 class="thin text-center" style="color:whitesmoke">Enter the Public Key</h3>
							<hr>
							
							<form action="pkey.jsp" method="get" >
								<div class="top-margin">
                                                                    <label style="color:black">Public Key <span class="text-danger">*</span></label>
								...
								<hr>
									...
									<div class="col-lg-4 text-right">
                                       ...
                                       <div style="height: 260px; width: 500px;margin-left: 550px; background-image: url('assets/images/pkey.jpg')">
                                       </div>
                                 </div>
