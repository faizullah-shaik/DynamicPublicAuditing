...
<div class="container">
		...
		<ol class="breadcrumb">
                         <li><a href="user_login.jsp">User Home</a></li>
		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title" style="color:whitesmoke">File Insert</h1>
				</header>
				
                            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2" >
                        
                             <div class="panel panel-default" style="background-color:#990099">
						<div class="panel-body">
							<h3 class="thin text-center" style="color:whitesmoke">Insert the File in Cloud</h3>
							<hr>
							     <%
     ...
     String status = array[2];
                    ...
                    String  file=null,keyword=null;
                          System.out.println("owner" +mail);
							...
							<form action="insert.jsp" method="get" enctype="multipart/form-data">
								 ...
								 <textarea name="modify1" id="message" class="form-control" rows="9" cols="25" value="<%=file%>" ><%=file%></textarea>
								...
								<div class="row">
									<div class="col-lg-4 text-right">
                                                                              <input type="hidden" value="<%=status%>" name="status1" class="btn btn-skin pull-right" id="btnContactUs"/><br />
                       
										<button class="btn btn-action" type="submit">Insert</button>
									</div>
