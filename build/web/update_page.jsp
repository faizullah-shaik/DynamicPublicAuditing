		...
		<div class="row">
			...
			<article class="col-xs-12 maincontent">
				<header class="page-header">
					<h1 class="page-title" style="color:whitesmoke">File Modify</h1>
				</header>
				
                            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2" >
                        
                             <div class="panel panel-default" style="background-color:cornflowerblue">
						<div class="panel-body">
							<h3 class="thin text-center" style="color:whitesmoke">Modify the File in Cloud</h3>
							<hr>
							     <%
