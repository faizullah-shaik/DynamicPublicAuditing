...
throws IOException{ 
    response.setContentType("text/html;charset=UTF-8");
        PrintWriter out = response.getWriter();
            ...
            pstmt = con.prepareStatement("insert into files (file_name, file_owner, size, file, data) values(?,?,?,?,?)");
            ...
            pstmt.setString(5, encstr);
             /*Cloud Start*/
                                File f1 = new File("C:\\Users\\Dell1\\Desktop\\input"+items.getName());
            ...
            if(i!=0){
             ...
             response.sendRedirect("f_upload.jsp?Error");
            ex.printStackTrace();
        } 
                finally{
                    out.close();
